...
using File = VirtoCommerce.Contentful.Models.File;

namespace VirtoCommerce.Contentful.Configuration
{
    /// <summary>
    /// JsonConverter for converting <see cref="VirtoCommerce.Contentful.Models.Management.ManagementAsset"/>.
    /// </summary>
